...
const uw = document.querySelector(".epic-button");
uw.style.cursor = "pointer";
uw.addEventListener("click", (e) => {
...
var Particles = (function (window, document) {
    ...
    Plugin.prototype.init = function (settings) {
        ...
        _.options.color = settings.color
            ? _._hex2rgb(settings.color)
            : _._hex2rgb(_.defaults.color);
            ...
            for (breakpoint in responsiveSettings) {
                ...
                if (responsiveSettings.hasOwnProperty(breakpoint)) {
                    if (responsiveSettings[breakpoint].options.color) {
                        responsiveSettings[breakpoint].options.color =
                            _._hex2rgb(
                                responsiveSettings[breakpoint].options.color
                            );
                    }
